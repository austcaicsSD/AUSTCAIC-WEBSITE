  ...
  cyber: [
    {
      ...
      icon: "dragon",
      topics: [
        "Introduction to Cyber and CTF platforms & challenge types",
      ...
      outcomes: [
        "Understand CTF workflow",
        "Navigate CTF platforms",
        "Solve beginner challenges",
        "Explain core security concepts",
        "Understand network fundamentals",
        "Use Linux for security tasks",
      ],
      tools: [
        "Kali Linux",
        "PicoCTF",
    ...
    },
    {
      ...
      outcomes: [
        ...
        "Investigate digital identities",
        "Analyze metadata",
        "Verify information sources",
        "Track digital footprints",
        "Solve OSINT challenges",
      ],
      tools: [
        "Google Dorking",
        "whois",
    ...
    },
    {
      ...
      outcomes: [
        "Understand Encoding, Encryption & Hashing",
        "Differentiate Encoding vs Hashing",
        "Learn core cryptography concepts",
        "Understand cryptography basics",
        "Apply encoding & hashing techniques",
        "Solve Crypto CTF challenges",
      ],
      tools: [
        "CyberChef",
        "dCode",
    ...
    },
    {
      ...
      outcomes: [
        ...
        "Learn post-exploitation methods",
      ],
      tools: ["Metasploit", "msfvenom", "Hydra", "linpeas"],
    },
    {
      week: "Class 09",
      date: "02/10/2026, Friday",
      title: "Grand Finale & Prize Giving",
      icon: "trophy",
      topics: [
        "Top Performers Announcement",
        "Certificate Distribution",
        "Career Guideline in Cybersecurity",
        "Networking & Future Roadmap",
      ],
      outcomes: [
        "Receive Recognition & Exclusive Prizes",
        "Plan Next Career Steps",
        "Network with Industry Peers",
        "Graduate as a Security Analyst",
      ],
      tools: ["Awards", "Certificates", "AUSTCAIC Swag"],
    },
  ],
  aiml: [
    {
      week: "Class 01",
      date: "18/07/2026, Saturday",
      ...
      outcomes: [
        ...
        "Use data structures and control flow",
        "Build a simple calculator",
      ],
      tools: ["Jupyter Notebook", "Calculator Exercise"],
    },
    {
      week: "Class 02",
      ...
      outcomes: [
        "Understand datasets and components",
        "Clean and prepare data",
        "Visualize and explore data",
        "Understand how data powers models",
      ],
    ...
    },
    {
      ...
      icon: "brain",
      topics: [
        "Supervised vs Unsupervised, Reg vs Class",
        "ML Pipeline (Train/Test, Evaluate)",
        "Algorithms: Linear Reg, Log Reg, Decision Tree, Random Forest, KNN",
        "Evaluation: MAE, RMSE, R  Score, Accuracy, Precision, Recall",
        "Overfitting vs Underfitting",
      ],
      outcomes: [
        "Understand core machine learning concepts",
        "Train and evaluate basic ML models",
        "Compare algorithms for different tasks",
    ...
    },
    {
      ...
      outcomes: [
        ...
        "Tune models using hyperparameters",
        "Reduce dimensionality and select features",
        "Understand clustering and RL basics",
      ],
      tools: ["XGBoost", "Scikit-Learn", "PCA", "K-Means"],
    },
    {
      week: "Class 05",
      ...
      icon: "network",
      topics: [
        "Why Deep Learning? & ANN",
        "Perceptron, Neurons, Layers & Weights",
      ...
      outcomes: [
        ...
        "Know the training process of an ANN",
        "Understand key DL hyperparameters",
      ],
      tools: ["PyTorch", "Jupyter Notebook"],
    },
    {
      week: "Class 06",
      date: "12/09/2026, Saturday",
      title: "Deep Learning Fundamentals",
      icon: "chip",
      topics: [
        "Challenges in DL (Overfitting, Dropout)",
        "Improving Model Performance",
        "CNN & RNN Introduction",
        "Future Roadmap: LSTM, Transformers, Transfer Learning",
        "NLP, Computer Vision & Generative AI",
      ],
      outcomes: [
        "Handle overfitting and improve models",
        "Gain an overview of CNN and RNN",
        "Explore future deep learning technologies",
      ],
      tools: ["PyTorch", "Jupyter Notebook"],
    },
    {
  ...
  research: [
    {
      ...
      icon: "search",
      topics: [
        "What is Research? & Why Research Matters",
        "Types of Research & Research Ethics",
        "Common Misconceptions",
        "Conference vs. Journal Papers",
        "Peer Review & Publication Lifecycle",
        "Identifying Predatory Venues",
      ],
      outcomes: [
        "Understand what research is and why it matters",
        "Identify different types of research",
        "Uphold research ethics",
        "Differentiate journals from conferences",
        "Recognize predatory venues",
      ],
      tools: ["Google Scholar", "IEEE", "Springer", "Elsevier"],
    },
    {
      week: "Class 02",
      date: "24/07/2026, Friday",
      ...
      topics: [
        ...
        "Reading systematically & Paper structure",
        "Taking notes while reading",
        "Organizing literature",
        "Scholarcy, Consensus, Elicit, Connected Papers",
        "Zotero / Mendeley",
      ],
      outcomes: [
        "Search and locate relevant literature efficiently",
        "Read and break down a paper's structure",
        "Take structured notes",
        "Use AI-assisted tools",
        "Manage references systematically",
      ],
      tools: ["Google Scholar", "Zotero", "Mendeley", "Connected Papers"],
    },
    {
      week: "Class 03",
      date: "21/08/2026, Friday",
      ...
      topics: [
        ...
        "Comparing different studies & Tables",
        "Synthesizing findings",
        "What is a Literature Gap?",
        "How to identify & validate opportunities",
        "Real-world examples",
      ],
      outcomes: [
        "Extract key data points from papers",
        "Build comparison tables",
        "Synthesize findings across literature",
        "Identify and validate genuine research gaps",
      ],
      tools: ["Comparison Templates", "Google Sheets", "Zotero Annotations"],
    },
    {
      week: "Class 04",
      date: "28/08/2026, Friday",
      title: "Methodology, Workflow & ML",
      icon: "rocket",
      topics: [
        "Formulating a research question",
        "Choosing a methodology",
        "Qualitative vs. Quantitative research",
        "End-to-end research logs",
        "Reading ML papers & benchmarks",
        "Reproducing results & Mini Review",
      ],
      outcomes: [
        "Formulate a clear research question",
        "Choose an appropriate methodology",
        "Manage an end-to-end workflow",
        "Apply skills to ML papers",
        "Present findings",
      ],
      tools: ["Notion", "GitHub", "Kaggle"],
    },
    {
      week: "Class 05",
      date: "04/09/2026, Friday",
      ...
      topics: [
        "Top Performers Announcement",
        "Certificate Distribution",
        "Publishing Guidance & Grants",
        "Networking & Future Roadmap",
      ],
      outcomes: [
        "Receive Recognition & Exclusive Prizes",
        "Plan Your First Publication",
        "Network with Professors",
        "Graduate as a Researcher",
      ],
      tools: ["Awards", "Certificates", "AUSTCAIC Swag"],
    },
  ],
