              ...
              <div className="flex justify-between items-center h-16 sm:h-20">
                ...
                <Link href="/" className="flex items-center gap-3 group">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xl sm:text-2xl font-black tracking-tight text-gray-950 leading-none">
                      AUST<span className="text-transparent bg-clip-text bg-gradient-to-r from-brandBlue to-brandPurple">CAIC</span>
                    </span>
                ...
                <div className="flex items-center gap-2 sm:gap-6">
                  ...
                  <div className="hidden sm:flex items-center gap-1 font-bold text-sm text-gray-600 bg-gray-100/50 p-1.5 rounded-xl border border-gray-200/30">
                    <Link href="/" className="px-4 py-2 rounded-lg hover:text-gray-950 hover:bg-white transition-all duration-300">
                      Home
                    </Link>
                    <Link href="/lab-free" className="px-4 py-2 rounded-lg hover:text-gray-950 hover:bg-white transition-all duration-300 flex items-center gap-1.5">
